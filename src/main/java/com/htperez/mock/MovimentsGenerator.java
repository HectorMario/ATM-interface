package com.htperez.mock;
import java.util.ArrayList;
import java.util.Arrays;
import java.util.concurrent.ThreadLocalRandom;

public class MovimentsGenerator {
    private ArrayList<String> typeMovements = new ArrayList<String>(
            Arrays.asList("Transfer: ", "Deposit: ", "Withdrawal: ", "Card payment: ", "Payroll deposit: ", "Bill payment: ")
    );
    public ArrayList<String> getMoviments(int quantityMoviments, String typemoney){
    ...
    private int positonRamdom(int min, int max){
